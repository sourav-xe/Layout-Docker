    ...
    <header className="flex items-center justify-between px-6 bg-neutralLight dark:bg-neutralDark shadow-md h-16 transition duration-300 sticky top-0 z-40">
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-xl font-semibold text-gray-700 dark:text-gray-200 ml-4">
            AccountCare
          </span>
        </div>
        {/* Search Bar */}
        <div className="relative ml-6">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="w-80 pl-10 pr-4 py-2 text-sm rounded-full border border-gray-300 dark:border-white/20 focus:outline-none focus:ring-2 focus:ring-primary bg-white dark:bg-neutralDark text-gray-800 dark:text-white placeholder-gray-400"
          />
        </div>
      </div>
      ...
      <div className="flex items-center space-x-4">
        ...
        <button className="p-2 rounded-full text-primary dark:text-white hover:bg-primary/10 dark:hover:bg-primary/20 transition" aria-label="Grid view">
          <Grid size={20} />
        </button>
        ...
        <button className="p-2 rounded-full text-primary dark:text-white hover:bg-primary/10 dark:hover:bg-primary/20 transition" aria-label="Phone">
          <Phone size={20} />
        </button>
        <button className="p-2 rounded-full text-primary dark:text-white hover:bg-primary/10 dark:hover:bg-primary/20 transition" aria-label="Help">
          <HelpCircle size={20} />
        </button>
        ...
        <div className="flex items-center space-x-2 cursor-pointer p-1.5 pr-3 rounded-full hover:bg-primary/10 dark:hover:bg-primary/20 transition">
          <img
            src="https://placehold.co/32x32/2563EB/ffffff?text=S"
            alt="User Avatar"
